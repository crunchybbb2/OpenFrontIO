...
export const maps: readonly MapInfo[] = [
  ...
  },
  {
    ...
    multiplayerFrequency: 6,
    customTribes: [
      { name: "DuPage County", coordinates: [527, 1223] },
      { name: "Emmet County", coordinates: [916, 604] },
      { name: "Erie County 1", coordinates: [1667, 1072] },
      { name: "Chautauqua County", coordinates: [1589, 1161] },
      { name: "Monroe County 1", coordinates: [1081, 1210] },
      { name: "St. Clair County", coordinates: [1186, 1044] },
      { name: "Livingston County 1", coordinates: [1783, 1078] },
      { name: "Warren County", coordinates: [1601, 1229] },
      { name: "Menominee County 1", coordinates: [592, 593] },
      { name: "Buffalo County", coordinates: [80, 800] },
      { name: "Cameron County", coordinates: [1731, 1291] },
      { name: "Lake County 1", coordinates: [537, 1145] },
      { name: "Muscatine County", coordinates: [159, 1283] },
      { name: "Wayne County 1", coordinates: [1112, 1152] },
      { name: "Erie County 2", coordinates: [1193, 1303] },
      { name: "Bayfield County", coordinates: [148, 427] },
      { name: "Newaygo County", coordinates: [806, 940] },
      { name: "Marquette2 County", coordinates: [581, 443] },
      { name: "Onondaga County", coordinates: [1976, 1032] },
      { name: "Niagara County", coordinates: [1665, 1000] },
      { name: "Lucas County", coordinates: [1067, 1261] },
      { name: "Ottawa County 1", coordinates: [1129, 1274] },
      { name: "Clare County", coordinates: [922, 867] },
      { name: "Gogebic County", coordinates: [331, 447] },
      { name: "Mackinac County", coordinates: [893, 505] },
      { name: "Noble County", coordinates: [852, 1297] },
      { name: "Will County", coordinates: [540, 1289] },
      { name: "Roscommon County", coordinates: [950, 808] },
      { name: "Lake County 2", coordinates: [118, 227] },
      { name: "Keweenaw County", coordinates: [485, 229] },
      { name: "Grant County", coordinates: [208, 1055] },
      { name: "Washburn County", coordinates: [76, 537] },
      { name: "Lincoln County", coordinates: [326, 635] },
      { name: "Lake County 3", coordinates: [613, 1294] },
      { name: "Baraga County", coordinates: [493, 402] },
      { name: "Cook County1", coordinates: [560, 1225] },
      { name: "Alpena County", coordinates: [1070, 688] },
      { name: "Huron County", coordinates: [1144, 893] },
      { name: "Sauk County", coordinates: [300, 962] },
      { name: "Trempealeau County", coordinates: [129, 813] },
      { name: "Grand Traverse County", coordinates: [835, 751] },
      { name: "Crawford County 1", coordinates: [181, 993] },
      { name: "Iron County 1", coordinates: [265, 473] },
      { name: "Rock Island County", coordinates: [225, 1286] },
      { name: "Scott County", coordinates: [218, 1258] },
      { name: "Door County", coordinates: [621, 703] },
      { name: "Cattaraugus County", coordinates: [1673, 1158] },
      { name: "Presque Isle County", coordinates: [1035, 635] },
      { name: "Macomb County", coordinates: [1155, 1084] },
      { name: "Cuyahoga County", coordinates: [1310, 1293] },
      { name: "Menominee County 2", coordinates: [451, 693] },
      { name: "Alger County", coordinates: [708, 448] },
      { name: "Florence County", coordinates: [489, 546] },
      { name: "Oswego County", coordinates: [1982, 962] },
      { name: "Ogemaw County", coordinates: [1010, 808] },
      { name: "Juneau County", coordinates: [280, 878] },
      { name: "Gratiot County", coordinates: [951, 984] },
      { name: "Leelanau County", coordinates: [804, 704] },
      { name: "Marinette County", coordinates: [534, 627] },
      { name: "Ashland County", coordinates: [211, 464] },
      { name: "Charlevoix County", coordinates: [888, 642] },
      { name: "Iron County 2", coordinates: [473, 483] },
      { name: "Adams County", coordinates: [322, 870] },
      { name: "Boone County", coordinates: [437, 1146] },
      { name: "Ogle County", coordinates: [377, 1192] },
      { name: "Steuben County 1", coordinates: [1831, 1155] },
      { name: "Kent County", coordinates: [836, 1028] },
      { name: "Manitowoc County", coordinates: [561, 845] },
      { name: "Tioga County", coordinates: [1847, 1236] },
      { name: "Potter County", coordinates: [1769, 1241] },
      { name: "Fillmore County", coordinates: [39, 920] },
      { name: "Lee County", coordinates: [379, 1240] },
      { name: "Allamakee County", coordinates: [126, 986] },
      { name: "Eaton County", coordinates: [923, 1100] },
      { name: "Ionia County", coordinates: [894, 1042] },
      { name: "Montcalm County", coordinates: [885, 981] },
      { name: "Ottawa County 2", coordinates: [782, 1040] },
      { name: "Otsego County", coordinates: [952, 690] },
      { name: "Kalamazoo County", coordinates: [838, 1158] },
      { name: "Missaukee County", coordinates: [892, 807] },
      { name: "Olmsted County", coordinates: [2, 864] },
      { name: "Livingston County 2", coordinates: [1036, 1099] },
      { name: "Schoolcraft County", coordinates: [757, 485] },
      { name: "Cass County", coordinates: [782, 1213] },
      { name: "Genesee County 1", coordinates: [1732, 1033] },
      { name: "LaGrange County", coordinates: [851, 1257] },
      { name: "Walworth County", coordinates: [472, 1088] },
      { name: "Elk County", coordinates: [1677, 1293] },
      { name: "Midland County", coordinates: [978, 925] },
      { name: "Sawyer County", coordinates: [155, 541] },
      { name: "Green County", coordinates: [343, 1086] },
      { name: "Rock County", coordinates: [407, 1088] },
      { name: "Rusk County", coordinates: [156, 611] },
      { name: "Douglas County", coordinates: [61, 443] },
      { name: "Dane County", coordinates: [365, 1022] },
      { name: "Outagamie County", coordinates: [481, 794] },
      { name: "Richland County", coordinates: [242, 970] },
      { name: "Forest County 1", coordinates: [444, 578] },
      { name: "Branch County", coordinates: [896, 1212] },
      { name: "Elkhart County", coordinates: [799, 1265] },
      { name: "Benzie County", coordinates: [779, 756] },
      { name: "Berrien County", coordinates: [731, 1206] },
      { name: "Winnebago County", coordinates: [396, 1143] },
      { name: "Delta County", coordinates: [669, 534] },
      { name: "Chemung County", coordinates: [1907, 1175] },
      { name: "Seneca County", coordinates: [1899, 1070] },
      { name: "Lafayette County", coordinates: [278, 1090] },
      { name: "Cortland County", coordinates: [1991, 1101] },
      { name: "Oakland County", coordinates: [1100, 1090] },
      { name: "Oscoda County", coordinates: [1009, 749] },
      { name: "Wood County 1", coordinates: [1071, 1303] },
      { name: "LaPorte County", coordinates: [691, 1273] },
      { name: "Sandusky County", coordinates: [1129, 1304] },
      { name: "Porter County", coordinates: [651, 1287] },
      { name: "Hillsdale County", coordinates: [953, 1217] },
      { name: "Allegan County", coordinates: [795, 1101] },
      { name: "Van Buren County", coordinates: [779, 1157] },
      { name: "DeKalb County", coordinates: [903, 1297] },
      { name: "Steuben County 2", coordinates: [903, 1257] },
      { name: "Ingham County", coordinates: [979, 1100] },
      { name: "Lenawee County", coordinates: [1017, 1216] },
      { name: "Sanilac County", coordinates: [1169, 962] },
      { name: "Delaware County", coordinates: [128, 1121] },
      { name: "Benton County", coordinates: [42, 1186] },
      { name: "Cheboygan County", coordinates: [964, 616] },
      { name: "Jackson2 County", coordinates: [973, 1158] },
      { name: "Crawford County 2", coordinates: [951, 748] },
      { name: "Lake County 4", coordinates: [805, 867] },
      { name: "Buchanan County", coordinates: [70, 1121] },
      { name: "Clayton County", coordinates: [131, 1059] },
      { name: "Ontonagon County", coordinates: [378, 402] },
      { name: "Cedar County", coordinates: [156, 1236] },
      { name: "Crawford County 3", coordinates: [1499, 1250] },
      { name: "Wyoming County1", coordinates: [1997, 1278] },
      { name: "Calhoun County", coordinates: [902, 1158] },
      { name: "Dubuque County", coordinates: [187, 1121] },
      { name: "Fayette County", coordinates: [69, 1056] },
      { name: "Houston County", coordinates: [112, 920] },
      { name: "Ontario County", coordinates: [1841, 1058] },
      { name: "Schuyler County", coordinates: [1893, 1134] },
      { name: "Barry County", coordinates: [866, 1101] },
      { name: "Clinton1 County", coordinates: [952, 1043] },
      { name: "Johnson County", coordinates: [101, 1253] },
      { name: "Forest County 2", coordinates: [1605, 1278] },
      { name: "Chippewa1 County", coordinates: [138, 682] },
      { name: "Burnett County", coordinates: [6, 544] },
      { name: "Barron County", coordinates: [69, 620] },
      { name: "Vilas County", coordinates: [353, 510] },
      { name: "Dodge County", coordinates: [452, 963] },
      { name: "Eau Claire County", coordinates: [137, 741] },
      { name: "Clark County", coordinates: [220, 739] },
      { name: "Marathon County", coordinates: [323, 711] },
      { name: "Carroll County", coordinates: [302, 1187] },
      { name: "Racine County", coordinates: [530, 1075] },
      { name: "Wood County 2", coordinates: [289, 787] },
      { name: "Portage County", coordinates: [355, 784] },
      { name: "La Crosse County", coordinates: [158, 881] },
      { name: "Waupaca County", coordinates: [420, 785] },
      { name: "Fond du Lac County", coordinates: [478, 907] },
      { name: "Price County", coordinates: [250, 576] },
      { name: "Dunn County", coordinates: [63, 703] },
      { name: "Monroe County 2", coordinates: [1793, 1009] },
      { name: "Taylor County", coordinates: [233, 657] },
      { name: "Stephenson County", coordinates: [335, 1141] },
      { name: "Howard County", coordinates: [12, 973] },
      { name: "Bay County", coordinates: [1026, 914] },
      { name: "Chickasaw County", coordinates: [12, 1023] },
      { name: "Kane County", coordinates: [485, 1209] },
      { name: "Pepin County", coordinates: [50, 765] },
      { name: "Ozaukee County", coordinates: [544, 969] },
      { name: "Genesee County 2", coordinates: [1061, 1030] },
      { name: "Henry County", coordinates: [278, 1304] },
      { name: "Bremer County", coordinates: [12, 1071] },
      { name: "Iowa County1", coordinates: [42, 1250] },
      { name: "Erie County 3", coordinates: [1508, 1200] },
      { name: "Bradford County", coordinates: [1937, 1233] },
      { name: "LaSalle County", coordinates: [430, 1306] },
      { name: "Jones County", coordinates: [156, 1179] },
      { name: "Montmorency County", coordinates: [1009, 689] },
      { name: "Washtenaw County", coordinates: [1045, 1157] },
      { name: "Vernon County", coordinates: [192, 934] },
      { name: "Tuscola County", coordinates: [1096, 955] },
      { name: "Isabella County", coordinates: [922, 926] },
      { name: "Kenosha County", coordinates: [533, 1104] },
      { name: "Calumet County", coordinates: [511, 851] },
      { name: "Kendall County", coordinates: [485, 1266] },
      { name: "Geauga County", coordinates: [1369, 1281] },
      { name: "Lycoming County", coordinates: [1870, 1306] },
      { name: "Wayne County 2", coordinates: [1874, 1007] },
      { name: "St. Joseph County", coordinates: [839, 1213] },
      { name: "Manistee County", coordinates: [774, 808] },
      { name: "Waukesha County", coordinates: [501, 1030] },
      { name: "Arenac County", coordinates: [1038, 854] },
      { name: "Jefferson County", coordinates: [443, 1030] },
      { name: "Orleans County", coordinates: [1728, 991] },
      { name: "Black Hawk County", coordinates: [13, 1121] },
      { name: "Iosco County", coordinates: [1069, 804] },
      { name: "Ashtabula County", coordinates: [1421, 1247] },
      { name: "Jo Daviess County", coordinates: [268, 1138] },
      { name: "Yates County", coordinates: [1865, 1094] },
      { name: "Kewaunee County", coordinates: [585, 777] },
      { name: "Jackson1 County", coordinates: [224, 1170] },
      { name: "Iowa County", coordinates: [278, 1033] },
      { name: "Monroe County 3", coordinates: [219, 874] },
      { name: "Jackson County", coordinates: [196, 811] },
      { name: "Alcona County", coordinates: [1074, 748] },
      { name: "Winona County", coordinates: [77, 867] },
      { name: "Linn County", coordinates: [99, 1186] },
      { name: "Langlade County", coordinates: [407, 648] },
      { name: "Marquette1 County", coordinates: [367, 895] },
      { name: "Gladwin County", coordinates: [978, 866] },
      { name: "Washington County", coordinates: [510, 971] },
      { name: "Tompkins County", coordinates: [1942, 1124] },
      { name: "Saginaw County", coordinates: [1018, 977] },
      { name: "Kalkaska County", coordinates: [892, 748] },
      { name: "McHenry County", coordinates: [483, 1145] },
      { name: "Williams County", coordinates: [953, 1271] },
      { name: "Venango County", coordinates: [1542, 1297] },
      { name: "Wexford County", coordinates: [833, 807] },
      { name: "Allegany County", coordinates: [1752, 1156] },
      { name: "Oconto County", coordinates: [505, 689] },
      { name: "Wyoming County", coordinates: [1728, 1083] },
      { name: "Tioga County1", coordinates: [1962, 1171] },
      { name: "Fulton County", coordinates: [1009, 1264] },
      { name: "Winnebago County1", coordinates: [459, 853] },
      { name: "Osceola County", coordinates: [864, 867] },
      { name: "McKean County", coordinates: [1687, 1230] },
      { name: "Antrim County", coordinates: [886, 694] },
      { name: "Shiawassee County", coordinates: [1007, 1041] },
      { name: "Lake County 5", coordinates: [1361, 1248] },
      { name: "Mason County", coordinates: [751, 866] },
      { name: "Bureau County", coordinates: [351, 1296] },
      { name: "DeKalb1 County", coordinates: [444, 1216] },
      { name: "Winneshiek County", coordinates: [69, 985] },
      { name: "Wabasha County", coordinates: [22, 817] },
      { name: "Green Lake County", coordinates: [410, 899] },
      { name: "Mecosta County", coordinates: [864, 926] },
      { name: "Muskegon County", coordinates: [763, 984] },
      { name: "Cayuga County", coordinates: [1932, 1047] },
      { name: "Luce County", coordinates: [837, 437] },
      { name: "Houghton County", coordinates: [454, 361] },
      { name: "St. Joseph1 County", coordinates: [746, 1262] },
      { name: "Oceana County", coordinates: [749, 926] },
      { name: "Sheboygan County", coordinates: [544, 912] },
      { name: "Cook County", coordinates: [229, 179] },
      { name: "Whiteside County", coordinates: [305, 1239] },
      { name: "Brown County", coordinates: [537, 788] },
      { name: "Waushara County", coordinates: [386, 846] },
      { name: "Dickinson County", coordinates: [553, 518] },
      { name: "Oneida County", coordinates: [352, 571] },
      { name: "Sullivan County", coordinates: [1937, 1289] },
      { name: "Clinton County", coordinates: [229, 1215] },
      { name: "Lapeer County", coordinates: [1120, 1018] },
      { name: "Chippewa County", coordinates: [955, 466] },
      { name: "Shawano County", coordinates: [444, 730] },
      { name: "Columbia County", coordinates: [375, 955] },
      { name: "Milwaukee County", coordinates: [542, 1032] },
      { name: "Orangeville", coordinates: [1500, 879] },
      { name: "Napanee", coordinates: [1884, 823] },
      { name: "Stayner", coordinates: [1501, 793] },
      { name: "Leamington", coordinates: [1196, 1190] },
      { name: "Penetanguishene", coordinates: [1520, 734] },
      { name: "Midland", coordinates: [1526, 737] },
      { name: "Perth", coordinates: [1969, 711] },
      { name: "Milton", coordinates: [1526, 947] },
      { name: "Kingsville", coordinates: [1178, 1192] },
      { name: "Smiths Falls", coordinates: [1997, 711] },
      { name: "Simcoe", coordinates: [1475, 1060] },
      { name: "Wallaceburg", coordinates: [1221, 1101] },
      { name: "Stouffville", coordinates: [1604, 870] },
      { name: "Gananoque", coordinates: [1980, 809] },
      { name: "Petawawa", coordinates: [1843, 537] },
      { name: "Bracebridge", coordinates: [1596, 687] },
      { name: "Grimsby", coordinates: [1566, 1001] },
      { name: "Brighton", coordinates: [1788, 858] },
      { name: "Beamsville", coordinates: [1576, 1006] },
      { name: "Georgetown", coordinates: [1524, 924] },
      { name: "Port Colborne1", coordinates: [1603, 1052] },
      { name: "Dunnville", coordinates: [1559, 1049] },
      { name: "Sturgeon Falls", coordinates: [1520, 455] },
      { name: "Temiskaming Shores1", coordinates: [1552, 250] },
      { name: "Renfrew", coordinates: [1916, 612] },
      { name: "King City", coordinates: [1570, 877] },
      { name: "Angus", coordinates: [1526, 810] },
      { name: "Arnprior", coordinates: [1956, 619] },
      { name: "Halton Hills", coordinates: [1523, 924] },
      { name: "Lakeshore", coordinates: [1169, 1149] },
      { name: "New Tecumseth", coordinates: [1528, 839] },
      { name: "Innisfil", coordinates: [1567, 811] },
      { name: "Minto", coordinates: [1409, 893] },
      { name: "Mono", coordinates: [1500, 874] },
      { name: "Saugeen Shores", coordinates: [1345, 780] },
      { name: "South Bruce Peninsula", coordinates: [1358, 757] },
      { name: "Georgina", coordinates: [1577, 826] },
      { name: "East Gwillimbury", coordinates: [1574, 849] },
      { name: "Bowmanville", coordinates: [1672, 880] },
      { name: "Pelham", coordinates: [1599, 1026] },
      { name: "Hamilton", coordinates: [1528, 990] },
      { name: "Cambridge", coordinates: [1474, 973] },
      { name: "Sarnia", coordinates: [1219, 1037] },
      { name: "Peterborough", coordinates: [1717, 813] },
      { name: "St. Catharines", coordinates: [1604, 1007] },
      { name: "Guelph", coordinates: [1482, 942] },
      { name: "Orillia", coordinates: [1583, 761] },
      { name: "Owen Sound", coordinates: [1397, 768] },
      { name: "Pembroke", coordinates: [1864, 550] },
      { name: "Burlington", coordinates: [1537, 979] },
      { name: "Brampton", coordinates: [1541, 918] },
      { name: "Mississauga", coordinates: [1556, 934] },
      { name: "Brantford", coordinates: [1480, 1010] },
      { name: "Woodstock", coordinates: [1420, 1011] },
      { name: "Waterloo", coordinates: [1449, 955] },
      { name: "Chatham", coordinates: [1246, 1132] },
      { name: "Kitchener", coordinates: [1452, 958] },
      { name: "Oshawa", coordinates: [1651, 882] },
      { name: "Niagara Falls", coordinates: [1627, 1019] },
      { name: "Vaughan", coordinates: [1570, 900] },
      { name: "Welland", coordinates: [1604, 1034] },
      { name: "Stratford", coordinates: [1393, 971] },
      { name: "London", coordinates: [1360, 1036] },
      { name: "Pickering", coordinates: [1623, 893] },
      { name: "Whitby", coordinates: [1641, 885] },
      { name: "St. Thomas", coordinates: [1367, 1070] },
      { name: "Port Colborne", coordinates: [1603, 1052] },
      { name: "Markham", coordinates: [1593, 889] },
      { name: "Sudbury", coordinates: [1391, 433] },
      { name: "Thorold", coordinates: [1610, 1012] },
      { name: "Temiskaming Shores", coordinates: [1552, 250] },
      { name: "Elliot Lake", coordinates: [1189, 454] },
      { name: "Richmond Hill", coordinates: [1581, 885] },
      { name: "Val-d'Or", coordinates: [1782, 143] },
      { name: "Kawartha Lakes", coordinates: [1665, 804] },
      { name: "Quinte West", coordinates: [1808, 848] },
      { name: "Barrie", coordinates: [1550, 799] },
      { name: "Trenton", coordinates: [1808, 848] },
    ],
  },
  {
    id: "GulfOfGuinea",
